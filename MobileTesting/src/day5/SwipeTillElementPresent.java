...
public class SwipeTillElementPresent {
	...
	public static void main(String[] args) throws MalformedURLException, InterruptedException {
		...
		//Using findElements and size() to know if the element is present. If not, it will go inside while loop and swipe
		while(driver.findElements(MobileBy.AndroidUIAutomator("UiSelector().text(\"Math mechanics of Thai banking crisis\")")).size()==0){
            Thread.sleep(5000);
		...
		driver.findElement(MobileBy.AndroidUIAutomator("UiSelector().text(\"Math mechanics of Thai banking crisis\")")).click();
	}
